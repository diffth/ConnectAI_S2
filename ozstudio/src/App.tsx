        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <p className="text-white/40 text-[12px] tracking-[0.15em] uppercase mb-3">Daily Pack</p>
              ...
              <p className="text-white/40 text-[13px] leading-relaxed mb-8">
                Essential daily micronutrients for optimal health.
              </p>
              <ul className="flex flex-col gap-3 mb-10 flex-1">
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> 30-day supply of daily vitamins
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Premium bioavailable minerals
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Eco-friendly biodegradable pack
                </li>
              </ul>
            ...
            >
              ...
              <p className="text-white/40 text-[12px] tracking-[0.15em] uppercase mb-3">Premium Bundle</p>
              <div className="flex items-baseline gap-1 mb-2">
                <span className="text-white text-[42px] font-light tracking-tight">$89.99</span>
                <span className="text-white/30 text-[14px]">/one-time</span>
              </div>
              <p className="text-white/40 text-[13px] leading-relaxed mb-8">
                All-in-one daily multivitamin, pure omega-3, and probiotics.
              </p>
              <ul className="flex flex-col gap-3 mb-10 flex-1">
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Everything in Daily Pack
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Pure wild-caught Omega-3
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> 50 Billion CFU active Probiotics
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Free worldwide shipping
                </li>
              </ul>
              <div className="flex flex-col gap-3">
                <PayPalCheckoutButton
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <p className="text-white/40 text-[12px] tracking-[0.15em] uppercase mb-3">Custom Kit</p>
              <div className="flex items-baseline gap-1 mb-2">
                <span className="text-white text-[42px] font-light tracking-tight">$149.99</span>
                <span className="text-white/30 text-[14px]">/one-time</span>
              </div>
              <p className="text-white/40 text-[13px] leading-relaxed mb-8">
                Custom formulated vitamins tailored to your biological profile.
              </p>
              <ul className="flex flex-col gap-3 mb-10 flex-1">
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Everything in Premium Bundle
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> DNA & blood biomarker compatibility
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
                  <span className="text-white/30">✓</span> Monthly online nutritionist consult
                </li>
                <li className="flex items-center gap-3 text-white/60 text-[13px]">
              ...
              <div className="flex flex-col gap-3">
                <PayPalCheckoutButton
                  product={PRODUCTS[2]}
                  onSuccess={(details) => handlePayPalSuccess(details, PRODUCTS[2].id, PRODUCTS[2].name, PRODUCTS[2].price)}
                  onError={(err) => console.error('PayPal error:', err)}
                />
                <a
                  href="mailto:contact@vitaglobe.com"
